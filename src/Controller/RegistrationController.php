...
class RegistrationController extends AbstractController
{
    ...
    ): Response
    {
        ...
        $user = new User();
        $filiere = $filiereRepository->find($data['filiere']);
    ...
    public function checkPassword(
        ...
        if($isPasswordValid){
            return $this->json(['message' => 'password is valid', 'response' => true]);
        }else{
            return $this->json(['message' => 'password is not valid', 'response' => false]);
        }
    }
}